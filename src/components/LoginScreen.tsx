...
import { GraduationCap, LayoutDashboard, Calendar, ClipboardCheck } from 'lucide-react';
        ...
        <div className="md:col-span-5 p-8 md:p-12 flex flex-col justify-center bg-white">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="w-full h-12 bg-indigo-600 hover:bg-indigo-700 text-white border border-transparent rounded-2xl flex items-center justify-center gap-3 transition-all duration-200 cursor-pointer text-sm font-semibold shadow-md shadow-indigo-600/10 active:scale-98 disabled:opacity-50"
            >
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-3 text-slate-400">
            ...
            <p className="text-[11px] leading-relaxed">
              *ระบบนี้เชื่อมต่อฐานข้อมูลโดยตรงกับ Google Sheets บนบัญชีของคุณครูอย่างสมบูรณ์แบบ สะดวกและปลอดภัย
            </p>
          </div>
        </div>
      </div>
